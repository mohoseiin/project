...
class Nowweek:
    ...
    def getnow(self):
        ...
        for x in range(7):
            days[x] = Gregorian(str(days[x].year) + '-' + str(days[x].month) + '-' + str(days[x].day)).persian_string()

        return days
    
    def listdate(self,s_day ,s_month ,s_year ,e_day ,e_month ,e_year):

        final = []
        s = Persian(str(s_year) + '-' + str(s_month) + '-' + str(s_day)).gregorian_tuple()
        e = Persian(str(e_year) + '-' + str(e_month) + '-' + str(e_day)).gregorian_tuple()
        ...
        for i in range(delta.days + 1):
            ...
            final.append(Gregorian(day).persian_tuple())
        return final